...
// Test Mode
function testMode() {
  var colorDanger = "color: #e74c3c; font-weight:bold;";
  var colorSuccess = "color: #1DCC70; font-weight:bold;";

  console.clear();
  console.log(
    "%cFINAPP",
    "font-size: 1.3em; font-weight: bold; color: #EAEAEA; background-color: #6236FF; padding: 10px 120px; margin-bottom: 16px;"
  );
  console.log(
  ...
  function testModeSubtitle(msg) {
    console.log(
      "%c # " + msg,
      "color: #EAEAEA; background: #444; font-size: 1.2em; padding: 8px 16px; margin-top: 16px; border-radius: 12px 12px 0 0"
    );
  }
...
$(".submit-btn").on("click touch", function (e) {
  var self = $(this);
